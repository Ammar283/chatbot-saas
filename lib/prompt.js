...
${missing.length
  ...
  : `- You now have every detail, so the request is COMPLETE. Say exactly this, in the visitor's language: "${s.bookingConfirmation}" Then stop asking for anything. Set "handoff" to true.
